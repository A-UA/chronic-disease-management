...
/// <reference types="D:/codes/chronic-disease-management/frontend/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "D:/codes/chronic-disease-management/frontend/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'chronic-disease-admin'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
